...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacitybacktitle=0.6, breakable, toprule=.15mm, rightrule=.15mm, coltitle=black, opacityback=0, colbacktitle=quarto-callout-caution-color!10!white, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, colback=white, left=2mm, leftrule=.75mm, bottomrule=.15mm, titlerule=0mm, colframe=quarto-callout-caution-color-frame, toptitle=1mm, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacitybacktitle=0.6, breakable, toprule=.15mm, rightrule=.15mm, coltitle=black, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colback=white, left=2mm, leftrule=.75mm, bottomrule=.15mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, bottomtitle=1mm]
...
\CommentTok{\# Supponiamo che model\_clm sia già il tuo modello "semplice"}
\NormalTok{model\_clm }\OtherTok{\textless{}{-}} \FunctionTok{clm}\NormalTok{(discipline }\SpecialCharTok{\textasciitilde{}}\NormalTok{ n\_yellow\_25 }\SpecialCharTok{+}\NormalTok{ n\_red\_25 }\SpecialCharTok{+}\NormalTok{ position }\SpecialCharTok{+}\NormalTok{ result, }\AttributeTok{data =}\NormalTok{ soccer)}

\CommentTok{\# Estrai coefficienti}
\NormalTok{thresholds }\OtherTok{\textless{}{-}}\NormalTok{ model\_clm}\SpecialCharTok{$}\NormalTok{Theta              }\CommentTok{\# soglie (intercette cumulative)}
\NormalTok{beta\_n\_yellow }\OtherTok{\textless{}{-}} \FunctionTok{coef}\NormalTok{(model\_clm)[}\StringTok{"n\_yellow\_25"}\NormalTok{]  }\CommentTok{\# coefficiente principale}

\CommentTok{\# Simula una sequenza di valori del predittore continuo}
\NormalTok{x\_vals }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\FunctionTok{min}\NormalTok{(soccer}\SpecialCharTok{$}\NormalTok{n\_yellow\_25), }\FunctionTok{max}\NormalTok{(soccer}\SpecialCharTok{$}\NormalTok{n\_yellow\_25), }\AttributeTok{length.out =} \DecValTok{100}\NormalTok{)}

\CommentTok{\# Calcola le log{-}odds cumulative per ogni soglia}
\NormalTok{plot\_data }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{x =}\NormalTok{ x\_vals,}
  \AttributeTok{Threshold\_1 =}\NormalTok{ thresholds[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{{-}}\NormalTok{ beta\_n\_yellow }\SpecialCharTok{*}\NormalTok{ x\_vals,}
  \AttributeTok{Threshold\_2 =}\NormalTok{ thresholds[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{{-}}\NormalTok{ beta\_n\_yellow }\SpecialCharTok{*}\NormalTok{ x\_vals}
\NormalTok{)}

\CommentTok{\# Porta in formato long}
\NormalTok{plot\_data\_long }\OtherTok{\textless{}{-}}\NormalTok{ plot\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{pivot\_longer}\NormalTok{(}
    \AttributeTok{cols =} \FunctionTok{starts\_with}\NormalTok{(}\StringTok{"Threshold\_"}\NormalTok{),}
    \AttributeTok{names\_to =} \StringTok{"Cumulative\_Log\_Odds\_Curve"}\NormalTok{,}
    \AttributeTok{values\_to =} \StringTok{"Log\_Odds"}
\NormalTok{  )}
...
{\centering \includegraphics{Ordinal_data_an_R_files/figure-pdf/unnamed-chunk-19-1.pdf}
...
\CommentTok{\# Prepara i dati con valori medi per le variabili continue, e livelli per position}
\NormalTok{new\_data }\OtherTok{\textless{}{-}} \FunctionTok{expand.grid}\NormalTok{(}
  \AttributeTok{position =} \FunctionTok{levels}\NormalTok{(soccer}\SpecialCharTok{$}\NormalTok{position),}
  \AttributeTok{n\_yellow\_25 =} \FunctionTok{mean}\NormalTok{(soccer}\SpecialCharTok{$}\NormalTok{n\_yellow\_25, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
  \AttributeTok{n\_red\_25 =} \FunctionTok{mean}\NormalTok{(soccer}\SpecialCharTok{$}\NormalTok{n\_red\_25, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
  \AttributeTok{result =} \FunctionTok{levels}\NormalTok{(soccer}\SpecialCharTok{$}\NormalTok{result)[}\DecValTok{1}\NormalTok{]  }\CommentTok{\# primo livello di result, ad es. "D"}
\NormalTok{)}

\CommentTok{\# Predici le probabilità cumulative (attenzione al tipo "cum.prob")}
\NormalTok{pred }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(model\_clm\_reduced, }\AttributeTok{newdata =}\NormalTok{ new\_data, }\AttributeTok{type =} \StringTok{"cum.prob"}\NormalTok{)}

\CommentTok{\# Trasforma in data frame, aggiungi la posizione}
\NormalTok{plot\_data }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(pred)}
\NormalTok{plot\_data}\SpecialCharTok{$}\NormalTok{position }\OtherTok{\textless{}{-}}\NormalTok{ new\_data}\SpecialCharTok{$}\NormalTok{position}

\CommentTok{\# Metti in formato long per ggplot}
\NormalTok{plot\_data\_long }\OtherTok{\textless{}{-}} \FunctionTok{pivot\_longer}\NormalTok{(plot\_data, }\AttributeTok{cols =} \SpecialCharTok{{-}}\NormalTok{position,}
                              \AttributeTok{names\_to =} \StringTok{"Threshold"}\NormalTok{, }\AttributeTok{values\_to =} \StringTok{"Cumulative\_Prob"}\NormalTok{)}

\CommentTok{\# Ordina posizione come fattore}
\NormalTok{plot\_data\_long}\SpecialCharTok{$}\NormalTok{position }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(plot\_data\_long}\SpecialCharTok{$}\NormalTok{position, }\AttributeTok{levels =} \FunctionTok{levels}\NormalTok{(soccer}\SpecialCharTok{$}\NormalTok{position))}
...
{\centering \includegraphics{Ordinal_data_an_R_files/figure-pdf/unnamed-chunk-20-1.pdf}
...
{\centering \includegraphics{Ordinal_data_an_R_files/figure-pdf/unnamed-chunk-25-1.pdf}
...
{\centering \includegraphics{Ordinal_data_an_R_files/figure-pdf/unnamed-chunk-29-1.pdf}
...
{\centering \includegraphics{Ordinal_data_an_R_files/figure-pdf/unnamed-chunk-35-1.pdf}
...
{\centering \includegraphics{Ordinal_data_an_R_files/figure-pdf/unnamed-chunk-38-1.pdf}
...
{\centering \includegraphics{Ordinal_data_an_R_files/figure-pdf/unnamed-chunk-41-1.pdf}
