...
Re can assess the fit and parsimony of a proportional odds model using pseudo-$R^2$ measures and AIC.

In R, the `DescTools::PseudoR2()` function provides several such measures:
...
# Nagelkerke's R2
r2_nagelkerke <- r2_coxsnell / (1 - exp((2 / n) * as.numeric(ll_null)))
...
```
  * Null hypothesis (H₀): PO assumption holds
